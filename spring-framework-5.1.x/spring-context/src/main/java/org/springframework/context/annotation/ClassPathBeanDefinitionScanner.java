...
public class ClassPathBeanDefinitionScanner extends ClassPathScanningCandidateComponentProvider {
	 ...
	 * @see #setEnvironment
	 * 	为容器创建一个类路径Bean定义扫描器，并制定是否使用默认的扫描过滤规则
	 */
	...
	/**
	 * 检查给定候选者的bean名称，确定是否需要注册相应的 beanDefinition 或与现有 beanDefinition 冲突。
	...
	/**
	 * 确定给定的新beanDefinition是否与给定的现有beanDefinition兼容。
	 * <p>当现有的 bean定义来自同一来源或来自非扫描来源时，默认实现将它们视为兼容。
