...
public class BeanDefinitionParserDelegate {
	 ...
	 * 在没有在本地显式设置默认值的情况下，通过回退到给定的父级来支持嵌套的'beans'元素用例。
	...
	/**
	 * 使用默认的lazy-init，autowire，依赖项检查设置，init-method，destroy-method和merge设置填充给定的DocumentDefaultsDefinition实例。
	 * 通过回退到{@code parentDefaults}，以支持嵌套的“beans”元素用例。
	...
	/**
	 * 如果适用，通过名称空间处理程序装饰给定的beanDefinition。
